"""
This module is a reproduction of the statistics module from Python 3.10 (https://github.com/python/cpython/blob/master/Lib/statistics.py)
There were no modifications performed.
I am reproducing it for compatibility with older Python versions.
